...
const HERO_CARDS = [
  { rot: -22, bg: 'linear-gradient(160deg,#2a2c6b,#533afd)', label: 'Everyday businesses', tag: 'WEB' },
  { rot: -11, bg: 'var(--canvas-cream)',                      label: 'Local SEO',            tag: 'SEO',    dark: true },
  { rot:   0, bg: 'var(--mesh)',                              label: 'Café brand',            tag: 'BRAND',  dark: true },
  { rot:  11, bg: 'linear-gradient(160deg,#0d253d,#273951)', label: 'Booking flow',          tag: 'UX'  },
  { rot:  22, bg: 'linear-gradient(160deg,#ea2261,#f96bee)', label: 'Socials kit',           tag: 'SOCIAL' },
]
